...
// publishes aggregate readiness. observedUID and observedFingerprint must be
// captured before the operation starts. A report is discarded if the current
// object has a different UID or gateway configuration fingerprint.
