...
// cleanOldLocalGWPorts handles removing old "br-local" ports on external switches leftover from old local gw mode
func cleanOldLocalGWPorts(nodeName string) {
